...
# --- Sidebar: elegir color de los títulos ---
title_color = st.sidebar.color_picker("Selecciona el color de los títulos", "#FFFFFF")

# --- CSS definido dentro del código ---
css = """
body {
...
top_n = st.sidebar.slider(
    "📊 Selecciona cuántos jugadores mostrar:",
    min_value=3,
...
st.markdown(
    ...
    <div style="display:flex; align-items:center; gap:15px; justify-content:center;">
        <h1 style="color:{title_color}; text-align:center; margin:0;">🐻 Chicago Cubs 2025 Batting Dashboard ⚾</h1>
    </div>
    """,
    unsafe_allow_html=True
)
...
st.markdown(
    f"<h3 style='text-align:center; color:{title_color}; margin-top:-10px;'>Análisis interactivo basado en estadísticas de la temporada 2025 (Baseball Savant)</h3>",
    unsafe_allow_html=True
)

# --- KPIs GLOBALS (Glassmorphism Cards) ---
st.markdown(f"### <span style='color:{title_color};'>📊 Team Summary — KPIs Globales</span>", unsafe_allow_html=True)
...
# --- TABS ---
tab1, tab2, tab3 = st.tabs(["🏅 Top Batters", "📈 Performance Evolution", "⚾ Team Production Breakdown"])
...
# ---------------- TAB 3 ----------------
with tab3:
    st.header("⚾ Team Production Breakdown")
    ...
    ax.set_title(f"Producción Ofensiva — Top {top_n} Jugadores", fontsize=14, weight='bold')
